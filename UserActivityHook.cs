...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        public static extern bool GetCursorPos(out RezSaver.Structs.POINT lpPoint);
        ...
        private void WritePoint(object sender, EventArgs e)
        {
            RezSaver.Structs.POINT p;
            if (GetCursorPos(out p))
            {
                fmMain fm = new fmMain();
                fm.tsslCursorPos.Text = Convert.ToString(p.X) + " : " + Convert.ToString(p.Y);
            }
        }
    }
}